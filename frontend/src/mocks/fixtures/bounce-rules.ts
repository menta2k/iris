...
const seeds: Seed[] = [
  ...
  { smtpCode: '421', enhancedCode: '4.7.0', provider: 'gmail', pattern: 'rate', class: 'soft', category: 'Rate Limited (Too Many Requests)', action: 'throttle', actionConfig: 'max_message_rate=100/h', suggestedAction: 'Reduce connection rate and sending speed to Gmail.', priority: 100 },
  { smtpCode: '421', enhancedCode: '', provider: 'yahoo', pattern: 'rate', class: 'soft', category: 'Rate Limited (Too Many Requests)', action: 'throttle', actionConfig: 'max_message_rate=100/h', suggestedAction: 'Back off; Yahoo is rate-limiting this IP.', priority: 100 },
  { smtpCode: '', enhancedCode: '4.7.0', provider: 'microsoft', pattern: 'throttl', class: 'soft', category: 'Rate Limited (Too Many Requests)', action: 'throttle', actionConfig: 'max_message_rate=100/h', suggestedAction: 'Reduce rate; Outlook/Microsoft throttling.', priority: 100 },
  { smtpCode: '', enhancedCode: '', provider: '', pattern: 'too many', class: 'soft', category: 'Rate Limited (Too Many Requests)', action: 'throttle', actionConfig: 'max_message_rate=50/h', suggestedAction: 'Slow down sending to this destination.', priority: 90 },
