    ...
    >
      <Form :model="form" layout="vertical">
        ...
        <FormItem label="Recipient (email or domain)" name="address">
          <Input v-model:value="form.address" placeholder="support@kmx.example.com" />
        </FormItem>
