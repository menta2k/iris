...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldFailedLogins:
			values[i] = new(sql.NullInt64)
		case user.FieldUsername, user.FieldEmail, user.FieldDisplayName, user.FieldPasswordHash, user.FieldLastLoginIP:
			values[i] = new(sql.NullString)
		case user.FieldDeactivatedAt, user.FieldLastLoginAt, user.FieldLockedUntil, user.FieldCreatedAt, user.FieldUpdatedAt:
	...
	for i := range columns {
		...
		case user.FieldFailedLogins:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.FailedLogins = int(value.Int64)
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.FailedLogins))
	builder.WriteString(", ")
