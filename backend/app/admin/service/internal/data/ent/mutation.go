...
// MailWebhookMutation represents an operation that mutates the MailWebhook nodes in the graph.
type MailWebhookMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*MailWebhook, error)
	predicates    []predicate.MailWebhook
}

var _ ent.Mutation = (*MailWebhookMutation)(nil)

// mailwebhookOption allows management of the mutation configuration using functional options.
type mailwebhookOption func(*MailWebhookMutation)

// newMailWebhookMutation creates new mutation for the MailWebhook entity.
func newMailWebhookMutation(c config, op Op, opts ...mailwebhookOption) *MailWebhookMutation {
	m := &MailWebhookMutation{
		config:        c,
		op:            op,
		typ:           TypeMailWebhook,
		clearedFields: make(map[string]struct{}),
...
// withMailWebhookID sets the ID field of the mutation.
func withMailWebhookID(id int) mailwebhookOption {
	return func(m *MailWebhookMutation) {
		var (
			err   error
			once  sync.Once
			value *MailWebhook
		)
		m.oldValue = func(ctx context.Context) (*MailWebhook, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().MailWebhook.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withMailWebhook sets the old MailWebhook of the mutation.
func withMailWebhook(node *MailWebhook) mailwebhookOption {
	return func(m *MailWebhookMutation) {
		m.oldValue = func(context.Context) (*MailWebhook, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m MailWebhookMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m MailWebhookMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *MailWebhookMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *MailWebhookMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().MailWebhook.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetName sets the "name" field.
func (m *MailWebhookMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *MailWebhookMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetName resets all changes to the "name" field.
func (m *MailWebhookMutation) ResetName() {
	m.name = nil
}

// SetAddress sets the "address" field.
func (m *MailWebhookMutation) SetAddress(s string) {
	m.address = &s
}

// Address returns the value of the "address" field in the mutation.
func (m *MailWebhookMutation) Address() (r string, exists bool) {
	v := m.address
	if v == nil {
		return
	}
...
// OldAddress returns the old "address" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MailWebhookMutation) ResetAddress() {
	m.address = nil
}

// SetURL sets the "url" field.
func (m *MailWebhookMutation) SetURL(s string) {
	m.url = &s
}

// URL returns the value of the "url" field in the mutation.
func (m *MailWebhookMutation) URL() (r string, exists bool) {
	v := m.url
	if v == nil {
		return
	}
...
// OldURL returns the old "url" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldURL(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MailWebhookMutation) ResetURL() {
	m.url = nil
}

// SetSecret sets the "secret" field.
func (m *MailWebhookMutation) SetSecret(s string) {
	m.secret = &s
}

// Secret returns the value of the "secret" field in the mutation.
func (m *MailWebhookMutation) Secret() (r string, exists bool) {
	v := m.secret
	if v == nil {
		return
	}
...
// OldSecret returns the old "secret" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldSecret(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MailWebhookMutation) ClearSecret() {
	m.secret = nil
	m.clearedFields[mailwebhook.FieldSecret] = struct{}{}
}

// SecretCleared returns if the "secret" field was cleared in this mutation.
func (m *MailWebhookMutation) SecretCleared() bool {
	_, ok := m.clearedFields[mailwebhook.FieldSecret]
	return ok
}

// ResetSecret resets all changes to the "secret" field.
func (m *MailWebhookMutation) ResetSecret() {
	m.secret = nil
	delete(m.clearedFields, mailwebhook.FieldSecret)
}

// SetEnabled sets the "enabled" field.
func (m *MailWebhookMutation) SetEnabled(b bool) {
	m.enabled = &b
}

// Enabled returns the value of the "enabled" field in the mutation.
func (m *MailWebhookMutation) Enabled() (r bool, exists bool) {
	v := m.enabled
	if v == nil {
		return
	}
...
// OldEnabled returns the old "enabled" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldEnabled(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEnabled is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEnabled resets all changes to the "enabled" field.
func (m *MailWebhookMutation) ResetEnabled() {
	m.enabled = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *MailWebhookMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *MailWebhookMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *MailWebhookMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *MailWebhookMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *MailWebhookMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the MailWebhook entity.
// If the MailWebhook object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MailWebhookMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *MailWebhookMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// Where appends a list predicates to the MailWebhookMutation builder.
func (m *MailWebhookMutation) Where(ps ...predicate.MailWebhook) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the MailWebhookMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MailWebhookMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MailWebhook, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *MailWebhookMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *MailWebhookMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (MailWebhook).
func (m *MailWebhookMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *MailWebhookMutation) Fields() []string {
	fields := make([]string, 0, 7)
	if m.name != nil {
		fields = append(fields, mailwebhook.FieldName)
	}
	if m.address != nil {
		fields = append(fields, mailwebhook.FieldAddress)
	}
	if m.url != nil {
		fields = append(fields, mailwebhook.FieldURL)
	}
	if m.secret != nil {
		fields = append(fields, mailwebhook.FieldSecret)
	}
	if m.enabled != nil {
		fields = append(fields, mailwebhook.FieldEnabled)
	}
	if m.created_at != nil {
		fields = append(fields, mailwebhook.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, mailwebhook.FieldUpdatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *MailWebhookMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *MailWebhookMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case mailwebhook.FieldName:
		return m.OldName(ctx)
	case mailwebhook.FieldAddress:
	...
	return nil, fmt.Errorf("unknown MailWebhook field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MailWebhookMutation) SetField(name string, value ent.Value) error {
	switch name {
	case mailwebhook.FieldName:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown MailWebhook field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *MailWebhookMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MailWebhookMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MailWebhookMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown MailWebhook numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *MailWebhookMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(mailwebhook.FieldSecret) {
		fields = append(fields, mailwebhook.FieldSecret)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *MailWebhookMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *MailWebhookMutation) ClearField(name string) error {
	switch name {
	case mailwebhook.FieldSecret:
		m.ClearSecret()
		return nil
	}
	return fmt.Errorf("unknown MailWebhook nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *MailWebhookMutation) ResetField(name string) error {
	switch name {
	case mailwebhook.FieldName:
		m.ResetName()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *MailWebhookMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MailWebhookMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *MailWebhookMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MailWebhookMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *MailWebhookMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *MailWebhookMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *MailWebhookMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown MailWebhook unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *MailWebhookMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown MailWebhook edge %s", name)
}
