...
var (
	...
	DefaultTargetID uint32
	// ValueValidator is a validator for the "value" field. It is called by the builders before save.
	ValueValidator func(string) error
	// TimeWindowValidator is a validator for the "time_window" field. It is called by the builders before save.
	TimeWindowValidator func(string) error
...
// ByTimeWindow orders the results by the time_window field.
func ByTimeWindow(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTimeWindow, opts...).ToFunc()
}
