...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			mailwebhook.Table:           mailwebhook.ValidColumn,
			...
			rulecondition.Table:         rulecondition.ValidColumn,
			ruletarget.Table:            ruletarget.ValidColumn,
			suppressionentry.Table:      suppressionentry.ValidColumn,
			user.Table:                  user.ValidColumn,
			virtualmta.Table:            virtualmta.ValidColumn,
			virtualmtagroup.Table:       virtualmtagroup.ValidColumn,
			virtualmtagroupmember.Table: virtualmtagroupmember.ValidColumn,
		})
	})
