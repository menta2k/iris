...
func newApp(
	...
	// IRIS_GEOIP_AUTO_UPDATE / metrics). Either way they join the kratos
	// lifecycle so clean shutdown waits on in-flight work.
	return bootstrap.NewApp(ctx, hs, gs, ls, ds, acs, ars, gus, hss, srs, ms)
}
